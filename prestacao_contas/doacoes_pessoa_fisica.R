...
cand_2020_BR <- fread("C:/Users/acaesar/Downloads/dados_15out2020/consulta_cand_2020/consulta_cand_2020_BRASIL.csv", 
                      encoding = "Latin-1",
                      drop = drop_columns,
                      colClasses = class_columns)

# importing CSV - prestação de contas / CANDIDATOS - RECEITA
receitas_candidatos <- fread("C:/Users/acaesar/Downloads/dados_15out2020/prestacao_de_contas_eleitorais_candidatos_2020/receitas_candidatos_2020_BRASIL.csv",
                             encoding = "Latin-1",
...
receitas_partidos <- fread("C:/Users/acaesar/Downloads/dados_15out2020/prestacao_de_contas_eleitorais_orgaos_partidarios_2020/receitas_orgaos_partidarios_2020_BRASIL.csv",
                               encoding = "Latin-1",
                               select = select_columns,
                               colClasses = class_columns_2)
...
t <- receitas_candidatos %>%
  ...
  summarise(valor = sum(VR_RECEITA))
