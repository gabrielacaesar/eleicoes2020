...
drop_columns <- c("DT_GERACAO", "HH_GERACAO", "CD_TIPO_ELEICAO", "NM_TIPO_ELEICAO", "CD_ELEICAO", "SG_UE", "DT_ELEICAO", "DS_ELEICAO")
...
bem_candidato_2016_BRASIL <- fread("~/Downloads/eleicao-2016/bem_candidato_2016/bem_candidato_2016_BRASIL.csv",
                               encoding = "Latin-1",
                               drop = c(paste0(drop_columns), "DT_ULTIMA_ATUALIZACAO", "HH_ULTIMA_ATUALIZACAO"))
...
joined_data <- bem_candidato_2016_BRASIL %>%
